function Block() {
	...
	this.upHeight = 950 - this.downHeight - this.gapHeight;
	...
	this.createBlock = function() {
		...
		this.upDivWrap = this.createDiv(null, null, "absolute", "1000px",0);
		...
		this.downDivWrap = this.createDiv(null, null, "absolute", "1000px", null, '198px');
